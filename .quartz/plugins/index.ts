...
export { AlignMode, AnchorSpace, BaseImage, DrawLayer, Drawing, DrawingKind, DrawingStyle, FillPatternKind, GridOverlay, GridShape, ImageOverlay, Marker, MarkerKind, MarkerLayer, RenderMode, ResolveError, ResolvedImageRef, StorageMode, TTRPGMapData, TextBaseline, TextBox, TextLayer, TextLayerStyle, YamlBaseImageEntry, YamlOptions, YamlOverlayEntry, TTRPGMap, DEFAULT_TRANSFORMER_OPTIONS, ResolvedMap, TransformerOptions } from "./obsidian-plugin-ttrpg-tools-maps"
...
export const plugins: Record<string, Record<string, (...args: unknown[]) => void>> = {
  ...
  "obsidian-plugin-ttrpg-tools-maps": {
    TTRPGMapEmitter: (...args: unknown[]) => { componentRegistry.setOptionOverrides("obsidian-plugin-ttrpg-tools-maps", args[0] as Record<string, unknown>); },
    TTRPGMapTransformer: (...args: unknown[]) => { componentRegistry.setOptionOverrides("obsidian-plugin-ttrpg-tools-maps", args[0] as Record<string, unknown>); },
  },
  "og-image": {
...
export const TTRPGMapEmitter = plugins["obsidian-plugin-ttrpg-tools-maps"].TTRPGMapEmitter
export const TTRPGMapTransformer = plugins["obsidian-plugin-ttrpg-tools-maps"].TTRPGMapTransformer
